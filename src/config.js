...
const bookingProcessAlias = 'allotme-default/release-1';
...
const siteTitle = 'AllotMe';

// Twitter handle is needed in meta tags (twitter:site). Start it with '@' character
const siteTwitterHandle = '@AllotMe_UK';

// Instagram page is used in SEO schema (http://schema.org/Organization)
const siteInstagramPage = 'https://www.instagram.com/allotme';
